      ...
      <div className="flex items-center gap-3 px-3 py-2 border-b border-outline-variant/40 shrink-0">
        ...
        <div className="ml-auto relative">
          ...
          <input
            ...
            className="bg-surface border border-outline-variant rounded pl-6 pr-2 py-1 text-xs font-mono text-on-surface placeholder:text-on-surface-variant focus:outline-none focus:border-primary w-44 transition-colors"
          />
        </div>
      </div>
          ...
          {virtualizer.getVirtualItems().map((item) => {
            ...
            return (
              <div
                ...
                className={`flex items-center px-3 border-b border-outline-variant/20 cursor-pointer transition-colors text-xs font-mono border-l-2 ${
                  isSelected
              ...
              >
                ...
                <span className={`truncate ${isSelected ? "text-on-surface" : "text-on-surface-dim"}`}>
                  {preview}
                </span>
              </div>
            );
